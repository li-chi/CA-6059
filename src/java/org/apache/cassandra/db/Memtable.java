...
public class Memtable implements Comparable<Memtable>
{
	...
	class MemMonitor implements Runnable {
		public void run() {
            ...
            String pid = parts[0];
			try (PrintWriter pw = new PrintWriter(new FileOutputStream(new File("c_memory.log"),true)))
			{
				while(true){
					pw.println(System.nanoTime()+","+runtime.totalMemory()/1048576+","+runtime.freeMemory()/1048576+","+runtime.maxMemory()/1048576+","+MEMORY_POOL.onHeap.usedNum()/1048576);
					pw.flush();
					Thread.sleep(100); 
				}
