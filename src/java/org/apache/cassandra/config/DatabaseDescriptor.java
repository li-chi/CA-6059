...
public class DatabaseDescriptor
{
    ...
    private static void applySimpleConfig()
    {
        ...
        System.out.println("memsize = "+Runtime.getRuntime().maxMemory() /  1048576);
        if (conf.memtable_offheap_space_in_mb == null)
            conf.memtable_offheap_space_in_mb = (int) (Runtime.getRuntime().maxMemory() / (4 * 1048576));
        conf.memtable_offheap_space_in_mb = 0; //changed
        ...
        //conf.memtable_heap_space_in_mb = (int) (Runtime.getRuntime().maxMemory() / (2 * 1048576)); //changed
        ...
        try
        {
            ...
            keyCacheSizeInMB =  (int) (Runtime.getRuntime().totalMemory() * 0.6 / 1024 / 1024);
        ...
        indexSummaryCapacityInMB = (int)(Runtime.getRuntime().totalMemory() * 0.60 / 1024 / 1024);
